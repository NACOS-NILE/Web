...
export default function Hero() {
  return (
    <section className="relative w-full h-[85vh] min-h-[600px] flex items-center bg-black overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto px-6 sm:px-12 pt-20">
        <div className="max-w-4xl pointer-events-none">
          <motion.h1 
            initial={{ opacity: 0, y: 40 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 1, delay: 0.2, ease: [0.16, 1, 0.3, 1] }}
            className="text-6xl sm:text-7xl lg:text-8xl font-serif font-bold tracking-tight text-white leading-[1.05]"
          >
            Welcome to <br />
          ...
          <motion.p 
            ...
            className="mt-8 text-xl sm:text-2xl text-gray-200 font-medium max-w-2xl"
          >
