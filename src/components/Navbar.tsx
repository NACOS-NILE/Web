    ...
    <>
      ...
      >
        <div className="max-w-[1440px] mx-auto px-6 md:px-12 flex items-center justify-between">
          ...
          >
            <div className="relative w-11 h-11 rounded-full bg-[#0d1021] border border-white/15 flex items-center justify-center p-1 transition-transform duration-300 group-hover:scale-105 group-hover:border-[#c1b3ff] overflow-hidden">
              <Image
                src="/logo.png"
                alt="NACOS Nile Logo"
                width={36}
            ...
            <div className="flex flex-col">
              <span className="text-[14px] md:text-[15px] font-bold tracking-tight text-[#f4f2ee] uppercase group-hover:text-[#c1b3ff] transition-colors">
                NACOS Nile
              </span>
          ...
          <div className="flex items-center gap-4">
            <Link
              href="#community"
              className="cut-corner-sm hidden sm:inline-flex items-center gap-2 text-[12px] font-mono uppercase tracking-wider text-[#c1b3ff] hover:text-[#070913] hover:bg-[#c1b3ff] px-4 py-2 border border-[#c1b3ff]/40 transition-all"
            >
              <span>Join Hub</span>
            ...
            <button
              ...
              className="cut-corner-sm group flex items-center gap-3 px-4 py-2 bg-white/[0.04] border border-white/15 hover:border-[#c1b3ff]/50 hover:bg-[#c1b3ff]/10 transition-all cursor-pointer"
            >
              <span className="text-[12px] font-mono tracking-widest uppercase text-[#f4f2ee] group-hover:text-[#c1b3ff] transition-colors">
                Menu
              </span>
              <div className="flex flex-col gap-1.5 w-5 justify-center">
                <span className="w-full h-[1.5px] bg-[#f4f2ee] group-hover:bg-[#c1b3ff] transition-all origin-right" />
                <span className="w-3/4 h-[1.5px] bg-[#c1b3ff] group-hover:w-full transition-all" />
                <span className="w-full h-[1.5px] bg-[#f4f2ee] group-hover:bg-[#c1b3ff] transition-all origin-right" />
              </div>
            </button>
          </div>
        ...
        {isOpen && (
          ...
          >
            ...
            <div className="max-w-[1440px] w-full mx-auto px-5 sm:px-8 md:px-12 py-3.5 sm:py-4 flex items-center justify-between border-b border-white/10 shrink-0">
              ...
              >
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-[9px] font-mono tracking-widest text-[#c1b3ff] uppercase">
              ...
              <button
                ...
                className="cut-corner-sm group flex items-center gap-2.5 px-3.5 py-1.5 bg-white/[0.04] border border-white/10 hover:border-[#c1b3ff]/60 hover:bg-[#c1b3ff]/10 transition-all cursor-pointer"
              >
                <span className="text-[11px] font-mono tracking-widest uppercase text-[#f4f2ee] group-hover:text-[#c1b3ff] transition-colors">
                  Close
                </span>
                <div className="relative w-3.5 h-3.5 flex items-center justify-center">
                  <span className="absolute w-3.5 h-[1.5px] bg-[#f4f2ee] rotate-45 group-hover:bg-[#c1b3ff] transition-colors" />
                  <span className="absolute w-3.5 h-[1.5px] bg-[#f4f2ee] -rotate-45 group-hover:bg-[#c1b3ff] transition-colors" />
                </div>
              </button>
            </div>
            ...
            <div className="max-w-[1440px] w-full mx-auto px-5 sm:px-8 md:px-12 py-2 sm:py-4 grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12 items-center flex-1 min-h-0 overflow-hidden">
              ...
              <div className="lg:col-span-8 flex flex-col justify-center space-y-1.5 sm:space-y-2 md:space-y-3">
                {navItems.map((item, idx) => (
                  ...
                  >
                    <Link
                      href={item.href}
                      onClick={() => setIsOpen(false)}
                      className="group flex items-baseline justify-between py-1.5 sm:py-2 md:py-3 border-b border-white/[0.06] hover:border-[#c1b3ff]/40 transition-colors"
                    >
                      <div className="flex items-baseline gap-3 sm:gap-6 md:gap-8">
                        <span className="text-[11px] sm:text-[12px] md:text-[13px] font-mono text-[#c1b3ff]/70 group-hover:text-[#c1b3ff] transition-colors">
                          {item.num}
                        </span>
                        <span className="text-[19px] xs:text-[22px] sm:text-[28px] md:text-[36px] lg:text-[40px] font-black tracking-tight text-[#f4f2ee] group-hover:text-[#c1b3ff] group-hover:translate-x-2 transition-all duration-200">
                          {item.name}
                        </span>
                      </div>
                      <div className="flex items-center gap-2">
                        ...
                        <ArrowUpRight className="w-4 h-4 text-white/30 group-hover:text-[#c1b3ff] group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-all" />
                      </div>
                    </Link>
                  </motion.div>
                ))}
                ...
                <div className="lg:hidden pt-3 flex items-center gap-2 flex-wrap">
                  <span className="text-[9px] font-mono uppercase tracking-widest text-[#c1b3ff] shrink-0">
                    Quick Jump:
                  </span>
                  <Link
                    href="#disciplines"
                    onClick={() => setIsOpen(false)}
                    className="text-[10px] font-mono px-2.5 py-1 cut-corner-sm bg-white/5 hover:bg-[#c1b3ff] hover:text-[#070913] text-[#f4f2ee] border border-white/10 transition-colors"
                  >
                    6 Disciplines
                  </Link>
                  <Link
                  ...
                  <Link
                    href="#community"
                    onClick={() => setIsOpen(false)}
                    className="text-[10px] font-mono px-2.5 py-1 cut-corner-sm bg-[#c1b3ff]/15 hover:bg-[#c1b3ff] text-[#c1b3ff] hover:text-[#070913] border border-[#c1b3ff]/30 transition-colors"
                  >
                    Community
                  </Link>
                </div>
              ...
              <div className="hidden lg:flex lg:col-span-4 flex-col justify-between bg-white/[0.02] border border-white/10 cut-corner p-6 max-h-[380px]">
                <div>
                  <div className="text-[10px] font-mono uppercase tracking-[0.2em] text-[#c1b3ff] font-semibold mb-4 flex items-center gap-2">
                ...
                <div className="pt-4 border-t border-white/10 flex flex-col gap-2">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <Link
                      href="#disciplines"
                      onClick={() => setIsOpen(false)}
                      className="text-[11px] font-mono px-3 py-1 cut-corner-sm bg-white/5 hover:bg-[#c1b3ff]/20 text-[#f4f2ee] hover:text-[#c1b3ff] border border-white/10 transition-colors"
                    >
                      6 Disciplines
                    </Link>
                    <Link
                    ...
                    <Link
                      href="#community"
                      onClick={() => setIsOpen(false)}
                      className="text-[11px] font-mono px-3 py-1 cut-corner-sm bg-[#c1b3ff]/10 hover:bg-[#c1b3ff]/20 text-[#c1b3ff] border border-[#c1b3ff]/30 transition-colors"
                    >
                      Join Hub
                    </Link>
                  </div>
            ...
            <div className="max-w-[1440px] w-full mx-auto px-5 sm:px-8 md:px-12 py-3 border-t border-white/5 flex items-center justify-between text-[10px] sm:text-[11px] font-mono text-white/40 shrink-0">
              ...
              <span className="text-[#c1b3ff]/80 font-bold shrink-0 ml-2">
                Learn • Build • Grow
              </span>
            </div>
          </motion.div>
